...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-4 d-flex justify-content-center">
      <a
        href="${pageContext.request.contextPath}/shared/login.jsp"
        class="btn btn-primary btn-lg me-3"
        style="min-width: 180px; font-size: 1.3rem"
        >Login to play</a
      >
      <a
        href="${pageContext.request.contextPath}/shared/signup.jsp"
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card game-card shadow-sm border-0 h-100">
                  <div class="card-body text-center p-4">
                    ...
                    <a
                      href="${pageContext.request.contextPath}/capitals/landing.jsp"
              ...
              <c:forEach
                var="game"
                items="${['Language Quiz','Science Trivia','History Quest','Logic Puzzles']}"
              >
                <div class="col-md-6 col-lg-4">
                  <div class="card game-card shadow-sm border-0 h-100">
                    <div class="card-body text-center p-4">
