        ...
        <div class="col-lg-10">
            ...
            <div class="text-center mb-4">
                <h1 class="display-4 text-primary">
                    <i class="bi bi-trophy-fill"></i> Math Game Results
                </h1>
            </div>
                    ...
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-header bg-info text-white">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-calculator-fill"></i> Your Answer
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
            ...
            <div class="text-center mt-4">
                <form method="get" action="mathgame" class="d-inline me-3">
            ...
            <!-- High Scores Table -->
            <jsp:include page="mathleaderboard.jsp" />
