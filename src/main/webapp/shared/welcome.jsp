...
<section class="hero-section text-center">
    <div class="container">
        <h1 class="display-1 fw-bold mb-4"><i class="bi bi-joystick"></i> Welcome to Torbesa</h1>
...
<section class="py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="text-center mb-5 display-6"><i class="bi bi-collection-play"></i> Available Games</h2>
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="${pageContext.request.contextPath}/capitals/landing.jsp" class="btn btn-primary btn-lg w-100"><i class="bi bi-play-fill"></i> Play Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Coming Soon Games -->
                    <c:forEach var="game" items="${['Language Quiz','Science Trivia','History Quest','Logic Puzzles']}">
                        <div class="col-md-6 col-lg-4">
                            <div class="card game-card shadow-sm border-0 h-100">
                                <div class="card-body text-center p-4">
                                    <div class="mb-3">
                                        <i class="bi bi-hourglass-split text-secondary" style="font-size: 3rem"></i>
                                    </div>
                                    <h5 class="card-title text-secondary mb-3">${game}</h5>
                                    <p class="card-text text-muted mb-4">Coming Soon!</p>
                                    <button class="btn btn-outline-secondary btn-lg w-100" disabled><i class="bi bi-hourglass-split"></i> Coming Soon</button>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
...
<footer class="footer py-4 mt-5">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <p class="mb-0"><i class="bi bi-c-circle"></i> 2024 Torbesa. All rights reserved.</p>
            </div>
            <div class="col-md-4 text-md-end">
                <p class="mb-0"><i class="bi bi-code-slash"></i> Licensed under <a href="https://opensource.org/licenses/MIT" class="text-white text-decoration-none">MIT License</a></p>
            </div>
        </div>
    </div>
</footer>
